...
def profile_sidebar():
    ...
    if "hype_min_energy" not in st.session_state:
        st.session_state.hype_min_energy = int(profile.get("hype_min_energy", 7))
    if "chill_max_energy" not in st.session_state:
        st.session_state.chill_max_energy = int(profile.get("chill_max_energy", 3))
    ...
    profile["hype_min_energy"] = st.session_state.hype_min_energy
    profile["chill_max_energy"] = st.session_state.chill_max_energy
